...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Ginger', 'Admin']
  ...
  # config.model AudioAsset do
  #   # Found associations:
  #   # Found columns:
  #     configure :id, :integer 
  #     configure :block_id, :integer 
  ...
  #   # Found associations:
  #     configure :reports, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
